    ...
    <section id="apartments" className="bg-slate-50 py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mb-10 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-primary">Байрны сонголт</p>
            <h2 className="text-3xl font-bold text-slate-950 text-balance md:text-4xl">2, 3 өрөө байрны сонголтууд</h2>
            <p className="mt-4 max-w-2xl leading-8 text-slate-600">План зураг, үнэ, м² болон зурагтай танилцаад захиалга өгөх боломжтой.</p>
          </div>
